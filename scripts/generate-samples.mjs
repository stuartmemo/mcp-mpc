...
const kitLabel = kits.length === 1 ? 'kit' : 'kits';
console.log(`Generated ${kits.length} original ${kitLabel} (${kits.reduce((count, [, voices]) => count + voices.length, 0)} samples) in ${output}`);
